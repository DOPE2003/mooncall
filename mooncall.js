...
// Fixed: reply directly; fast-ACK handled by middleware above
...
// Text flow (no thesis; admin bypass 24h rule)
bot.on("text", async (ctx) => {
  ...
  // Ignore commands here (handled by command handlers above)
